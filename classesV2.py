...
class Funcionario(Usuario): #falta implementar
    def __init__(self, id, nome, senha, email, contrato):
...
class Professor(Funcionario):
    def __init__(self, id, nome, senha, email, contrato, matricula):
        super().__init__(id, nome, senha, email, contrato)
...
class Aluno(Usuario):
    def __init__(self, id, nome, senha, email, matricula):
        super().__init__(id, nome, senha, email)
        self._matricula = matricula
        self._listChaves = []
...
class adapterBD:
    ...
    def deleteUsuario(self, usuario):
        supabase.table('usuarios').delete().eq('id', usuario.getId()).execute()
